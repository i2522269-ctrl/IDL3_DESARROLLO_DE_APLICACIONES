...
<head>
    ...
    <title>Editar Libro - Librería DDA</title>
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-white py-3">
                    <h4 class="mb-0 text-warning"><i class="fas fa-edit me-2"></i>Editar Libro</h4>
                </div>
                    ...
                    <form action="procesar.php" method="POST" class="needs-validation" novalidate>
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="sku" name="sku" value="<?php echo htmlspecialchars($libro['sku']); ?>" required>
                            </div>
                            <div class="col-md-6">
                                <label for="stock" class="form-label">Stock Actual</label>
                                <input type="number" class="form-control" id="stock" name="stock" value="<?php echo $libro['stock']; ?>" min="0" required>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" step="0.01" class="form-control" id="precio_costo" name="precio_costo" value="<?php echo $libro['precio_costo']; ?>" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text">S/</span>
                                    <input type="number" step="0.01" class="form-control" id="precio_venta" name="precio_venta" value="<?php echo $libro['precio_venta']; ?>" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-4 d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-warning px-5">Actualizar Libro <i class="fas fa-sync ms-2"></i></button>
                        </div>
                    </form>
                </div>
            </div>
